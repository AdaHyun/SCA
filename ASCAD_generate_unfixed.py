...
if __name__ == "__main__":
	if len(sys.argv)!=2:
		...
		original_raw_traces_file = ascad_data_folder + "rawDatabase/ASCAD.h5"
		...
		profiling_desync=0
		attack_desync=0
		extract_traces(original_raw_traces_file, ascad_databases_folder + "ASCAD_fixedkey.h5"		  , profiling_index, attack_index, target_points, profiling_desync=0, attack_desync=0)
		extract_traces(original_raw_traces_file, ascad_databases_folder + "ASCAD_fixedkey_desync50.h5" , profiling_index, attack_index, target_points, profiling_desync=0, attack_desync = 50)
		extract_traces(original_raw_traces_file, ascad_databases_folder + "ASCAD_fixedkey_desync100.h5", profiling_index, attack_index, target_points, profiling_desync=0, attack_desync = 100)
