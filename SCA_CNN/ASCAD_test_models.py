...
if __name__ == "__main__":
	if len(sys.argv)!=2:
		...
		model_file="/root/autodl-tmp/SCA/Attack/CNN_pytorch/my_cnn_best_desync0_epochs100_batchsize128.h5"
		ascad_database=traces_file="/root/autodl-tmp/SCA/data/processedData/ASCAD_fixedkey.h5"
		num_traces=2000
		target_byte=2
		multilabel=0
		simulated_key=0
