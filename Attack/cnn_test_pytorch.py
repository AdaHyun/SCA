...
def check_model(model_file, ascad_database, num_traces=2000, target_byte=2):
    ...
    ranks = full_ranks(preds, Xa_expand, Ma, 0, num_traces, 10, target_byte)
...
if __name__ == "__main__":
    model_file = "/root/autodl-tmp/SCA/Attack/CNN/pytorch_my_cnn_best_desync0_epochs75_batchsize200.pth"
